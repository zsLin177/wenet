...
nohup python wenet/bin/train_base_ner.py --gpu 1 \
      --config conf/train_macbert_basener.yaml \
      --seed 666 \
      --data_type raw \
      ...
      --model_dir exp/macbert_base_s666 \
      ...
      --pin_memory > macbert_base_s666.log 2>&1 &