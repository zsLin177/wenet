...
python wenet/bin/recognize_spner.py --gpu 0 \
      --mode ctc_greedy_search \
      --config exp/m3t_ctcw0.1_h256/train.yaml \
      --data_type raw \
      --test_data ner_data/test/data.list \
      --checkpoint exp/m3t_ctcw0.1_h256/best.pt \
      --beam_size 10 \
      --batch_size 64 \
      --penalty 0.0 \
      ...
      --ctc_weight 0.5 \
      --reverse_weight 0.0 \
      --result_file exp/m3t_ctcw0.1_h256/test_pred